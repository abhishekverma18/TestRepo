...
namespace ProvisioningPrototype
{
    public class SkinManagerHelper
    {
        ...
        public static bool UpdatePortalLogo(string logoFileName, string skinFolderPath, string appDataPath)
        {
            ...
            string newLogoImagePath = Path.Combine(appDataPath, @"Uploads\" + logoFileName);
        ...
        public static bool UpdatePortalHeader(string headerFileName, string skinFolderPath, string appDataPath)
        {
            ...
            string newHeaderImagePath = Path.Combine(appDataPath, @"Uploads\" + headerFileName);
        ...
        public static bool UpdateSurveyHeader(string headerFileName, string skinFolderPath, string appDataPath)
        {
            if (null == headerFileName)
            {
                return true;
        ...
        /*--------------------Portal and Survey Skin Updates for Dynamic Variables-----------------*/
            ...
            string propertyName, bool isPortal)
        {
            ...
            {
                commonCss = commonCss.Replace(substitution, propertyName + ": #" + hexCode + ";");
            }
            else
            {
                throw new Exception(substitution + " not found in common.css");
            }
            ...
            string propertyName, bool isPortal)
        {
            ...
            if (commonCss.Contains(substitution))
            {
                commonCss = commonCss.Replace(substitution, propertyName + ": " + value + ";");
            }
            else
            {
                throw new Exception(substitution + " not found in common.css");
        ...
        public static bool UpdateDynamicImage(string fileName, string skinFolderPath, string appDataPath, string propertyName, bool isPortal)
        {
            if (null == fileName)
            {
                return true;
            ...
            {
                throw new Exception("File-Type is non-jpg");
            }

            string imageFilePath = isPortal ? Res.PortalImageFilePath : Res.SurveyImageFilePath;
            imageFilePath = imageFilePath + propertyName + ".jpg";

            string combinedImagePath = Path.Combine(skinFolderPath, imageFilePath);
            ...
            string newImagePath = Path.Combine(appDataPath, @"Uploads\" + fileName);
            Exists(newImagePath);
        ...
        public static string CompressFolder(string inputFolderPath, string skinFolderPath, string newFolderName, string zipFileName)
        {
            ...
            //Added  for returning skin folder path
