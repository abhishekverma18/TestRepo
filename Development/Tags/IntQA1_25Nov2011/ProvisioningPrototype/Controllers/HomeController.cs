...
namespace ProvisioningPrototype.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult LoadFromZip(int id)
        {
            ...
            if (!_automationService.ExtractPreviouslyGeneratedSkinPackageZip(Server.MapPath(Res.SkinsDirectoryPath)))
            {
                temps.GuiTemplates[id].SelectedTemplate = "-2";
            ...
            temps.GuiTemplates[id].SelectedTemplate = "-1";
            return Json(temps.GuiTemplates[id], "application/json", JsonRequestBehavior.AllowGet);
        }
