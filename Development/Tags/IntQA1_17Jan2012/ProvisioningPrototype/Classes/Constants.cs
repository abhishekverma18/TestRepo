...
namespace ProvisioningPrototype
{
    ...
    {
        public const string FileComponent = "FileUpload()";// Modified by K.G(07-12-2011) to support file upload control for all the groups.
        public const string ChoiceComponent = "ChoiceSelector()";  // Modified by K.G(06-12-2011) to support choice selector control for all the groups.
