...
namespace ProvisioningPrototype.Web_Automation
{
    public class Home
    {
        ...
        public static void HomeViewPostToPanelSettingsManager(PanelPreferences preferences)
        {
            ...
            preferences.CookieJar.SourceCode = pageSource;
        ...
        public static void HomeViewPostToCommunication(PanelPreferences preferences)
        {
            var homeViewUrl = new Uri(preferences.PanelAdminUrl + "HomeView.aspx");
            string homeViewFormParams = GetHomeViewToCommunicationFormParams();
            var bytes = Encoding.ASCII.GetBytes(homeViewFormParams);
        ...
        private static string GetHomeViewToCommunicationFormParams()
        {
            const string eventTarget = "CommunicationButton";
            const string eventArgument = "";
            const string vcViewState = "14";
            string viewState = String.Empty;
            const string ctlCurrentXPos = "0";
            const string ctlCurrentYPos = "0";
            const string loggingOut = "false";
