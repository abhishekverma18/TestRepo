...
namespace ProvisioningPrototype.Models
{
    public class PreferencesModel
    {
        ...
        private List<SelectListItem> _availableContext = new List<SelectListItem>();
        ...
        // Added for Available context management by Optimus
        [Display(Name = "Available context")]
        public string ContextValue { get; set; }
        public IEnumerable<SelectListItem> AvailableContextSelectList { get; set; }
        ...
        */
        ...
        // Added for offline and Advanced mode by Optimus
