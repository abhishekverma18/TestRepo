...
namespace ProvisioningPrototype.Web_Automation
{
    ...
    {
        public static CookieJar PanelSettingsUpdatePost(CookieJar cookieJar, ContextCollection collection, PanelPreferences preferences)
        {
            ...
            var panelSettingsRequest = AutomationHelper.CreatePost(panelSettingsViewUrl, cookieJar);
        ...
        public static CookieJar PanelSettingsPostToAssetManager(CookieJar cookieJar, PanelPreferences preferences)
        {
            var panelSettingsViewUrl = new Uri(preferences.PanelAdminUrl + "PanelSettingsManagementView.aspx");
            string panelSettingsViewFormParams = GetPanelSettingsToAssetManagerFormParams();
            var bytes = Encoding.ASCII.GetBytes(panelSettingsViewFormParams);

            var homeViewRequest = AutomationHelper.CreatePost(panelSettingsViewUrl, cookieJar);
